...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    if [[ "$distro" == "arch" ]]; then
       ...
       sudo pacman -S unace unrar zip unzip p7zip sharutils uudeview arj cabextract file-roller dtc xz python-pip brotli lz4 gawk libmpack aria2 python2 python2-pip
       pip2 install backports.lzma protobuf pycrypto
    else
